...
static const char qt_meta_stringdata_MyQFrame[] = {
    "MyQFrame\0\0nextEjercicio()\0"
};
...
const QMetaObjectExtraData MyQFrame::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MyQFrame::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_MyQFrame,
      qt_meta_data_MyQFrame, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MyQFrame::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyQFrame))
